...
# Upsample: 边界bins.shape:[1024,64] 两个边界形成的区域内的权重weights.shape:[1024,63] n_samples:16
def sample_pdf(bins, weights, n_samples, det=False):
    ...
    # bins.unsqueeze(1) [1024,1,64] matched_shape [1024, 8, 65]
...
def extract_geometry(bound_min, bound_max, resolution, threshold, query_func, outside_val=1.0):
    ...
    # vertices, triangles = mcubes.MarchingCubes(u, threshold)
